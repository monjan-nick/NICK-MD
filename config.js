...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "*©  Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ ɴɪᴄᴋ ᴍᴅ*",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "ʜɪ ᴀᴍ ᴀʟɪᴠᴇ ɴᴏᴡ ᴀᴍ ɴɪᴄᴋ ᴍᴅ ᴛʜᴇ ʙᴇsᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ🚀",
    ...
    AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "`Status Seen By Nick Bot 🦄 `",
